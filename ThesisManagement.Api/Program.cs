...
builder.Services.AddScoped<IStartDefensePeriodCommand, StartDefensePeriodCommand>();
builder.Services.AddScoped<IMoveNextDefensePeriodCommand, MoveNextDefensePeriodCommand>();
builder.Services.AddScoped<IPauseDefensePeriodCommand, PauseDefensePeriodCommand>();
builder.Services.AddScoped<IResumeDefensePeriodCommand, ResumeDefensePeriodCommand>();
builder.Services.AddScoped<ILockScoringDefensePeriodCommand, LockScoringDefensePeriodCommand>();
builder.Services.AddScoped<ICloseDefensePeriodCommand, CloseDefensePeriodCommand>();
